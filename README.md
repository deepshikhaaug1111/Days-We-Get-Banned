...
<li><a class="nav-link hover:text-blue-700" href="#articles">Read More</a></li>
...
<p class="text-gray-600 max-w-2xl mx-auto leading-relaxed">
            We are a collective of disillusioned satirists, disgruntled artists, and recovering journalists. Our mission is simple: to publish the kind of content that makes powerful people uncomfortable, all while wondering how many days we have left before the plug is pulled. We believe in the power of laughter to expose truth, and the power of truth to eventually get you banned.
        </p>
</section>
</main>
<footer class="footer py-12 text-gray-600" id="contact">
<div class="container mx-auto px-4">
<div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
<div>
<h4 class="font-playfair text-xl font-semibold text-gray-800 mb-3">Days Till We Get Banned</h4>
<p class="text-sm">Pushing boundaries, one satirical piece at a time. Enjoy it while it lasts.</p>
</div>
<div>
<h4 class="font-semibold text-gray-800 mb-3">Quick Links</h4>
<ul class="space-y-2 text-sm">
<li><a class="hover:text-blue-600" href="#">Archive</a></li>
<li><a class="hover:text-blue-600" href="#submit">Submission Guidelines</a></li>
<li><a class="hover:text-blue-600" href="#">Support Our Work (Seriously)</a></li>
<li><a class="hover:text-blue-600" href="#">Privacy Policy (The Boring Part)</a></li>
</ul>
</div>
<div>
<h4 class="font-semibold text-gray-800 mb-3">Follow Our Descent</h4>
